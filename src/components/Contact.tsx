...
const Contact: React.FC = () => {
  ...
  return (
    <section className="bg-beige">
      ...
      {/* New section */}
      <div className="max-w-6xl py-4 mx-auto lg:py-10 md:px-6 flex flex-wrap"> {/* Reduced lg:py-20 to lg:py-10 */}
        <div className="w-full md:w-1/2 px-4 mb-10 xl:mb-0">
          ...
          <p className="mb-4 text-base leading-7 text-black">
            When you join, you’ll become part of a growing community of current and former professional dancers who are talking about career change. You’ll also get:
          </p>
        </div>
