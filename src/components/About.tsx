        ...
        <div className="flex flex-wrap">
          <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
            <div className="lg:max-w-md">
              ...
              <animated.div style={textAnimation}>
                <p className="px-4 mb-10 leading-7 text-black mb-6 font-montserrat">
                ...
                <p className="px-4 mb-10 leading-7 text-black mb-6 font-montserrat">
                  Created by dancers who've done it, we'll help you find
                  <span className="text-lg font-bold"> meaningful work </span>
                  off the stage whether due to injuries, illness, or shifts in priorities.
                </p>
          ...
          <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 ">
            <animated.img
              ...
              alt="Female dancer elegantly balancing "
