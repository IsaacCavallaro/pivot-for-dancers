    ...
    return (
        <section id="about" className="relative overflow-hidden bg-beige pt-24 pb-10">
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-0">
                ...
                >
                    <h1
                        className={`font-merriweather text-center text-5xl md:text-6xl lg:text-6xl font-bold text-black mb-6 leading-tight transition-all duration-1000 ${isVisible
