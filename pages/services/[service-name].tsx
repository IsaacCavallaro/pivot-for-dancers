...
const ServicePage = () => {
    ...
    const { 'service-name': serviceName } = router.query;

    // Find the service based on the service name
    const service = services.find((s: Service) =>
        s.name.toLowerCase().replace(/ /g, '-') === serviceName
    );
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="p-8">
                                ...
                                <div className="flex items-center gap-2 mb-6">
                                    <div className="flex items-center">
                                        {[...Array(5)].map((_, i) => (
                                            <Star
                                                key={i}
                                                className={`w-5 h-5 ${i < Math.floor(service.rating)
                                ...
                                <div className="text-center text-sm text-brown-gray">
                                    {service.id === 4 && "Limited Availability"}
                                </div>
                            </div>
                        </div>
                    </div>
