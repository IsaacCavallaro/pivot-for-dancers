    ...
    return (
        <section id="products" className="bg-beige min-h-screen py-12 md:py-16 px-4 sm:px-6 overflow-hidden">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    <h1
                        className={`text-bold text-center text-5xl md:text-6xl lg:text-6xl font-bold text-black mt-8 mb-6 leading-tight transition-all duration-1000 ${isVisible.title
